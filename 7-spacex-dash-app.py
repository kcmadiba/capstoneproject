...
def get_pie_chart(entered_site):
    if entered_site == 'ALL':
        ...
        data['outcome'] = data['outcome'].map({0: 'Failure', 1: 'Success'})
        fig = px.pie(data, values='count', names='outcome', title='Total Success Launches for All Sites')
    else:
        ...
        data.columns = ['outcome', 'count']
        data['outcome'] = data['outcome'].map({0: 'Failure', 1: 'Success'})
        fig = px.pie(data, values='count', names='outcome', title=f'Success Launches for {entered_site}')
    return fig
...
def get_scatter_chart(entered_site, payload_range):
    ...
    if entered_site == 'ALL':
        ...
        # Scatter plot for the selected site within payload range
